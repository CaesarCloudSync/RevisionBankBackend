class CaesarCreateTables:
    def __init__(self) -> None:
        ...
        self.revisioncardimagefields = ("revisioncardimgname","filetype","revisioncardhash","revisioncardimage")
    ...
    def create(self,caesarcrud):
        ...
        ("varchar(255) NOT NULL","varchar(255) NOT NULL","varchar(255) NOT NULL","MEDIUMBLOB"),
        "revisioncardimages")
